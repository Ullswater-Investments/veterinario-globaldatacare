      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 pt-20 pb-20">
          <div className="text-center max-w-5xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500">El primer Espacio de Datos Federado de Salud Buco Dental en Europa</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm">
              ...
              <Link to="/legal" className="text-slate-400 hover:text-white transition">
                Aviso Legal
              </Link>
            </div>
          </div>
